...
VL_ATTR_COLD void Vtop___024root___eval_initial__TOP(Vtop___024root* vlSelf) {
    ...
    // Body
    vlSelf->top__DOT__inst_RegFile__DOT__regfile[0U] = 0ULL;
}
...
VL_ATTR_COLD void Vtop___024root___stl_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__src1 = vlSelf->top__DOT__inst_RegFile__DOT__regfile
    ...
    if ((0x13U == (IData)(vlSelf->top__DOT__opcode))) {
        vlSelf->top__DOT__dst_valid = (0U == (7U & 
                                              (vlSelf->inst 
                                               >> 0xcU)));
    }
}
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__dst_valid = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__inst_RegFile__DOT__i = VL_RAND_RESET_I(32);
    for (int __Vi0 = 0; __Vi0 < 32; ++__Vi0) {
        vlSelf->top__DOT__inst_RegFile__DOT__regfile[__Vi0] = VL_RAND_RESET_Q(64);
    }
